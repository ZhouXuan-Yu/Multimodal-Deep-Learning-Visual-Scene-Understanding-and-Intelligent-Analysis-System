'''
代码作用是加载数据集，包括图片和标签，# YOLOv5 🚀 by Ultralytics, GPL-3.0 license
'''
...
from app.design_competition.utilss.general import xyxy2xywh, xywh2xyxy, xywhn2xyxy, clean_str
from app.design_competition.utilss.torch_utils import torch_distributed_zero_first
