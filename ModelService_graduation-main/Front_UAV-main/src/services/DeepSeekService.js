...
class DeepSeekService {
   ...
   */
  static simulateProgress(requestId, onProgress, totalTime = 5000) {
    const steps = 10; // 进度步数
   ...
   * @returns 智能分析结果
   */
  static async getAnalysis(prompt, model = DeepSeekModel.V3) {
...
`;
  ...
  static async generateForecastAnalysis(
    ...
    const castsData = forecastData.casts.map((cast, index) => {
...
// 导出
export { RequestStatus, DeepSeekModel };
